...
<div class="row small-up-2 large-up-4">
	<?php
	       $sql = 'SELECT * FROM `adidas_product` WHERE `adidas_category_id` = 5 ORDER BY `adidas_category_id` ASC LIMIT 4';
...
<div class="row small-up-2 medium-up-3 large-up-6">
	<?php
	       $sql2 = 'SELECT * FROM `adidas_product` WHERE `adidas_category_id` = 5;';
	       $q2 = $pdo->prepare($sql2);
	       $q2->execute(array());
