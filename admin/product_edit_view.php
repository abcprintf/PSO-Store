...
<div class="row" id="content">
	...
	<div class="medium-9 columns">
	    ...
	    <div class="button-group">
	    	<!--<a href="product_add.php" class="primary button"><i class="fa fa-plus"></i> Add</a>
      		<a href="product_edit_view.php" class="warning button"><i class="fa fa-pencil-square-o"></i> Edit</a>
      		<a href="#" class="alert button"><i class="fa fa-times"></i> Delete</a>-->
        ...
        <tbody>
          ...
          $i=0;
           ...
           foreach ($pdo->query($sql) as $row) {
                    ...
                    echo '<td><a href="product_edit.php?id='.$row['adidas_product_id'].'" class="warning button"><i class="fa fa-pencil-square-o"></i></a></td>';
                    echo '</tr>';
           }
		  ?>
        </tbody>
