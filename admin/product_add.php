	...
	<div class="medium-9 columns">
    	...
    	<nav aria-label="You are here:" role="navigation">
        	<ul class="breadcrumbs">
          		...
          		<li><span class="show-for-sr">Current: </span> Add</li>
        	</ul>
      	</nav>
      	<hr>
        ...
        <div class="row">
          <div class="medium-6 columns">
            <label>ชื่อสินค้า
              <input type="text" placeholder="ชื่อสินค้า" name="product_name">
            </label>
          </div>
          <div class="medium-6 columns">
            <label>ราคา
              <div class="input-group">
		        <input class="input-group-field" type="number" name="price">
         ...
         <div class="row">
          ...
          <div class="medium-4 columns">
            <label>ชื่อหัวข้อสินค้า (ที่โชว์)
              <input type="text" placeholder="ชื่อหัวข้อสินค้า (ที่โชว์)" name="title_name">
            </label>
          </div>
          <div class="medium-4 columns">
