	...
	<div class="medium-9 columns">
    	...
    	<nav aria-label="You are here:" role="navigation">
      	...
      	<div class="callout primary">
	       	<h4>View all orders edit.</h4>
	    </div>
	    
	    <div class="button-group">
	    	<!--<a data-open="myModal_2" class="primary button"><i class="fa fa-plus"></i> Add</a>-->
      		<a href="order_view.php" class="button"><i class="fa fa-arrow-left"></i> Back</a>
          ...
          $i=0;
           ...
           foreach ($pdo->query($sql) as $row) {
                    ...
                    if($row['orders_status'] == 'Not payments'){
                    	echo '<td>ยังไม่ได้ชำระ</td>';
           			}else{
           				echo '<td><span style="background-color:#3FFF00;">ชำระเรียบร้อยแล้ว</span></td>';
           			}
                    if($row['payment'] == 0){
                    	echo '<td>ยังไม่ได้ชำระ</td>';
           			}else{
           				echo '<td><span style="background-color:#FF9800;">ชำระเรียบร้อยแล้ว</span></td>';
           			}
           			echo '<td><a href="order_view_info.php?id='.$row['adidas_reference_id'].'" class="warning button"><i class="fa fa-pencil-square-o"></i></a></td>';
                    echo '</tr>';
           }
		  ?>
        </tbody>
