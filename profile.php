        ...
        <form action="sent_active.php" method="post">
          <div class="row collapse">
            ...
            <div class="small-10  columns">
              <input type="text" placeholder="name" name="name" value="<?php echo $name;?>" disabled>
            </div>
          </div>
          <div class="row collapse">
            <div class="small-2  columns text-center">
            ...
            <div class="small-10  columns">
              <input type="text" placeholder="lastname" name="lastname" value="<?php echo $lastname;?>" disabled>
            </div>
          </div>
          <div class="row collapse">
            <div class="small-2  columns text-center">
            ...
            <div class="small-10  columns">
               <textarea placeholder="Address" name="address" disabled><?php echo $address;?></textarea>
            </div>
            ...
            <div class="small-10  columns">
              <input type="text" placeholder="Tel" name="tel" value="<?php echo $tel;?>" disabled>
            </div>
          </div>
