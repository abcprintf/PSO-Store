		...
		<table class="hover text-center">
			...
			?>
			  <tr>
			    ...
			    <td></td>
			    <td></td>
			    <td><?php echo $total_price_sum.' THB';?></td>
			    <td></td>
			  </tr>
			  <tr>
			    <td>Vat (7%)</td>
			  ...
			  <tr>
			    ...
			    <td></td>
			    <td></td>
			    <td><?php echo $totalsum.' THB';?></td>
			    <td></td>
			  </tr>
			</tbody>
		</table>
			<span><a href="cart.php" class="button"><i class="fa fa-arrow-left"></i> Back</a></span>
			<span style="float: right;"><a href="success.php" class="success button right" onclick="return confirm('are you sure check out?')"><i class="fa fa-check"></i> Confirm</a></span>
		<?php } ?>
	</div>
</div>
